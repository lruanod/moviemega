<div class="row">
    ...
    <div class="col-12 text-white text-center">
        ...
        <div class="container bg-dark text-warning rounded"><br>
                ...
                <br><br>
            <img class="rounded" src="{{asset("storage/".$descargaprograma->descarga->logod)}}" alt="Generic placeholder image" width="60" height="45"><br>
            <span>Servidor: {{$descargaprograma->descarga->servidord}}/{{$descargaprograma->lenguajeprograma->lenguaje->nombrel}}/{{$descargaprograma->lenguajeprograma->lenguaje->descripcionl}}</span> <br><br>
        </div><br>
