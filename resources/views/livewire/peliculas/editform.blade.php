...
<div class="row form-group">
    ...
    <input type="file" class="form-control col-md-5" wire:model.defer="portada2" id="{{$identificador2}}">
    @error('portada2') <span class="text-warning">{{$message}}</span> @enderror
</div>
...
<div class="card-body align-content-center">
    <div wire:loading wire:target="portada2" class="alert alert-danger">
        <ul>
    ...
    @if ($portada2)
        ...
        <img class="rounded" src="{{$portada2->temporaryUrl()}}" width="250vw" height="150vh" >
        <br>
    @endif
    @if ($portada3)
        <label  class="text-white align-content-center" >Imagen actual</label><br>
        <img class="rounded" src="{{asset("storage/$portada3")}}" width="250vw" height="150vh" >
    @endif
</div> <br>
